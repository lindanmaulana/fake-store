...
export const CategoryPopular = async ({categories}: CategoryPopularProps) => {

    return (
        <section id="category" className="py-14">
            <div className="container max-w-6xl mx-auto px-4 lg:px-0">
                <h2 className="text-2xl md:text-3xl font-bold">Kategori Popular</h2>
                <p className="text-base text-gray-500">Jelajahi produk berdasarkan kategori</p>

                <div className="py-5 flex items-center flex-wrap md:flex-nowrap gap-4">
