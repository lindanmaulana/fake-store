            ...
            <CardBody>
                <div className="flex flex-col md:flex-row items-center justify-between gap-y-4">
                    ...
                    <div className="w-full md:w-1/3 flex items-center gap-3 justify-start md:justify-end">
                        <Button variant="bordered" className="border bg-white text-black font-semibold">Lihat Semua Produk</Button>
                        <Button className="bg-gradient-to-r from-blue-600 to-purple-500 px-4 py-2 rounded-xl text-white shadow-lg hover:shadow-purple-500 font-semibold">Chat WhatsApp</Button>
                    </div>
                </div>
            </CardBody>
        </Card>
